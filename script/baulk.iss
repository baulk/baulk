...
VersionInfoCopyright=Copyright © 2026. Baulk contributors
...
Source: "..\script\fragments-arm64.ps1"; DestDir: "{app}\script"; DestName: "fragments-arm64.ps1"
Source: "..\script\fragments-arm64.bat"; DestDir: "{app}\script"; DestName: "fragments-arm64.bat"
Source: "..\script\fragments-delete.bat"; DestDir: "{app}\script"; DestName: "fragments-delete.bat"
Source: "..\script\register-unscrew.ps1"; DestDir: "{app}\script"; DestName: "register-unscrew.ps1"
Source: "..\script\register-unscrew.bat"; DestDir: "{app}\script"; DestName: "register-unscrew.bat"
Source: "..\script\unregister-unscrew.ps1"; DestDir: "{app}\script"; DestName: "unregister-unscrew.ps1"
Source: "..\script\unregister-unscrew.bat"; DestDir: "{app}\script"; DestName: "unregister-unscrew.bat"
#if "user" == InstallTarget
