...
ATTRIB_SSE41
#endif
void MY_FAST_CALL LzFind_SaturSub_128(UInt32 subValue, CLzRef *items, const CLzRef *lim)
{
  v128 sub2 =
    #ifdef MY_CPU_ARM_OR_ARM64
...
ATTRIB_AVX2
#endif
void MY_FAST_CALL LzFind_SaturSub_256(UInt32 subValue, CLzRef *items, const CLzRef *lim)
{
