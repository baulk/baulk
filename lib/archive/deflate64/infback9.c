 ...
 */
int ZEXPORT inflateBack9Init_(z_stream *strm, unsigned char *window,
 ...
 */
int ZEXPORT inflateBack9(strm, in, in_desc, out, out_desc) z_stream *strm;
in_func in;
void *in_desc;
out_func out;
void *out_desc;
...
int ZEXPORT inflateBack9End(z_stream *strm) {
