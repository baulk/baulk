...
#define BAULK_VERSION_FULL                                              \
  BAULK_VERSION_MAIN L"." BAULK_PATCH

#ifdef APPVEYOR_BUILD_NUMBER
#define BAULK_BUILD_VERSION                                             \
  BAULK_VERSION_FULL L"." BAULKSUBVER L" (appveyor)"
#else
#define BAULK_BUILD_VERSION                                             \
  BAULK_VERSION_FULL L"." BAULKSUBVER L" (dev)"
#endif
