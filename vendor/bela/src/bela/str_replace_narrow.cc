...
// occurred.
int ApplySubstitutions(std::string_view s, std::vector<strings_internal::ViableSubstitution> *subs_ptr,
...
std::string StrReplaceAll(std::string_view s, strings_internal::FixedMapping replacements) {
