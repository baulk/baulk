...
enum {
  ...
  EF_HEXAGON_MACH_V67T = EF_HEXAGON_ISA_V67 | EF_HEXAGON_TINY_CORE, // Hexagon V67T
  ...
  EF_HEXAGON_MACH_V71T = EF_HEXAGON_ISA_V71 | EF_HEXAGON_TINY_CORE, // Hexagon V71T
...
struct Elf32_Rel {
  ...
  void setSymbolAndType(Elf32_Word s, unsigned char t) { r_info = (s << 8) + t; }
};
...
struct Elf64_Rel {
  ...
  void setSymbolAndType(Elf64_Word s, Elf64_Word t) { r_info = ((Elf64_Xword)s << 32) + (t & 0xffffffffL); }
};
...
enum : unsigned {
  ...
  AARCH64_PAUTH_PLATFORM_LLVM_LINUX_VERSION_LAST = AARCH64_PAUTH_PLATFORM_LLVM_LINUX_VERSION_FPTRTYPEDISCR,
};
