...
class flat_map_slot_type:
    CLASS_PATTERN = "^gtl::priv::raw_hash_set<gtl::priv::FlatHashMapPolicy.*>::slot_type$"
    HAS_SUMMARY = True
...
class node_map_slot_type:
    CLASS_PATTERN = r"gtl::priv::raw_hash_set<gtl::priv::NodeHashMapPolicy.*>::slot_type$"
    HAS_SUMMARY = True
    IS_SYNTHETIC_PROVIDER = False
...
class node_set_slot_type:
    CLASS_PATTERN = r"gtl::priv::raw_hash_set<gtl::priv::NodeHashSetPolicy.*>::slot_type$"
    HAS_SUMMARY = True
    IS_SYNTHETIC_PROVIDER = False
...
class flat_hash_map_or_set:
    CLASS_PATTERN = "^gtl::flat_hash_(map|set)<.*>$"
    HAS_SUMMARY = True
...
class parallel_flat_or_node_map_or_set:
    CLASS_PATTERN = "^gtl::parallel_(flat|node)_hash_(map|set)<.*>$"
    HAS_SUMMARY = True
    IS_SYNTHETIC_PROVIDER = True
